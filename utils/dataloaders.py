...
def dataset_stats(path='coco128.yaml', autodownload=False, verbose=False, profile=False, hub=False):
    ...
    Usage1: from yolov5.utils.dataloaders import *; dataset_stats('coco128.yaml', autodownload=True)
    Usage2: from yolov5.utils.dataloaders import *; dataset_stats('path/to/coco128_with_yaml.zip')
    Arguments
